-- Tele_juan365 Breaktime Dashboard Database Schema
...
CREATE TABLE IF NOT EXISTS break_types (
    id INTEGER PRIMARY KEY,
    code TEXT UNIQUE NOT NULL,        -- B, W, O
    name TEXT NOT NULL,               -- Break, WC, Other
    display_name TEXT NOT NULL,       -- ☕ Break, 🚻 WC, etc.
    time_limit_minutes INTEGER,       -- 60, 15, NULL
